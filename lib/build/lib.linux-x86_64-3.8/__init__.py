...
def image_to_world_ray(image_points, camera_metadata):
    ...
    if image_points.shape[0] == 1:
        ...
        return av_utils._pixel2WorldRay(image_points, intrinsic, camera_model, img_height, rolling_shutter_delay, exposure_time, T_eof, poses, pose_timestamps)[0,:]
    else:
        return av_utils._pixel2WorldRay(image_points, intrinsic, camera_model, img_height, rolling_shutter_delay, exposure_time, t_eof, poses, pose_timestamps)
