...
from src.py.data_converter.data import DataWriter, FThetaCameraModel, LabelSource, Poses, ShutterType
        ...
        for camera_id, camera_rig_name in self.CAMERAID_TO_RIGNAME.items():
            ...
            if self.shard_id == 0:
                ...
                self.data_writer.store_camera_meta(
                    ...
                    FThetaCameraModel(intrinsic[2:4].astype(np.uint64), ShutterType.ROLLING_TOP_TO_BOTTOM,
