...
class FThetaCameraModelParameters(CameraModelParameters, dataclasses_json.DataClassJsonMixin):
    ...
    def transform(
        ...
        Args:
            ...
            image_domain_offset: an offset of the image domain after the above scaling (e.g., to account for cropping).
        ...
        principal_point = (
            (self.principal_point + 0.5) * image_domain_scale_factor
            - 0.5
        ...
        angle_to_pixeldist_poly = self.angle_to_pixeldist_poly * image_domain_scale_factor
