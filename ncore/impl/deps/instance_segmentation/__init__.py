...
def run_instance_segmentation(
    image_handles: list[Tuple[int, EncodedImageHandle]], output_dir: Path, index_digits: int, use_pointrend=True
):
    cfg = get_cfg()
    if use_pointrend:
        best_model_config = "ncore/impl/deps/instance_segmentation/configs/InstanceSegmentation/pointrend_rcnn_X_101_32x8d_FPN_3x_coco.yaml"
