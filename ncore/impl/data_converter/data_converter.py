...
class BaseNvidiaDataConverter(DataConverter):
    ...
    @classmethod
    def get_constants(
        cls, rig_properties: dict[str, str], rig_sensor_ids: Sequence[str]
    ) -> Hyperion8Constants | Hyperion81Constants:
        ...
        assert isinstance(
            constants, (BaseNvidiaDataConverter.Hyperion8Constants, BaseNvidiaDataConverter.Hyperion81Constants)
