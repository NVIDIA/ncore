...
The NRECore-SDK python APIs are provided as ``pip``-installable wheels maintained in the repositories `package registry <https://gitlab-master.nvidia.com/nrs/ncore/-/packages>`_.
