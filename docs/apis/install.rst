...
The ``NCORE`` python APIs are provided as ``pip``-installable wheels maintained in the repositories `package registry <https://gitlab-master.nvidia.com/Toronto_DL_Lab/ncore/-/packages>`_.
