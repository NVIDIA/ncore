...
def nvidia_deepmap_v3(ctx, *_, **kwargs):
    ...
    from dsai_internal.data_converter.nvidia_deepmap3 import NvidiaDeepmapConverter
...
def nvidia_maglev_v3(ctx, *_, **kwargs):
    ...
    from dsai_internal.data_converter.nvidia_maglev3 import NvidiaMaglevConverter
