...
@cli.command()
@click.option(
    "--start-timestamp-us", type=int, default=None, help="If provided, the start timestamp to restrict processing to"
)
@click.option(
    "--end-timestamp-us", type=int, default=None, help="If provided, the end timestamp to restrict processing to"
)
@click.pass_context
