...
@click.option(
    "--n-neighbors", type=int, help="Number of neighbors used in the k-nn search for the normal estimation", default=20
)
@click.option(
    "--trim-distance",
    type=float,
...
def ncore_surface_rec(
    ...
    pid, nf = pcu.estimate_point_cloud_normals_knn(
