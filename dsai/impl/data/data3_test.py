    ...
    def test_shard_sensor(self):
        ...
        self.assertIsNone(
            np.testing.assert_array_equal(
                ...
                [[0.9999999403953552, -0.0003129387041553855, -2.207939360232558e-05, -0.00034731917548924685],
        ...
        self.assertIsNone(
            np.testing.assert_array_equal(
                ...
                [[0.9999999403953552, -0.0002774616295937449, -2.3144866645452566e-05, -0.00047207626630552113],
                 [0.00027746273553930223, 0.9999999403953552, 4.720890865428373e-05, 0.001981734996661544],
                 [2.3131768102757633e-05, -4.721532968687825e-05, 1.0, 0.00020380940986797214], [0.0, 0.0, 0.0, 1.0]]))
        ...
        self.assertIsNone(
            np.testing.assert_array_equal(
                ...
                [[1.0, 5.302716817823239e-05, -3.7100351619301364e-05, -0.0008849087171256542],
                 [-5.301716009853408e-05, 0.9999999403953552, 0.00026968304882757366, 0.000253729842370376],
                 [3.711465251399204e-05, -0.0002696810697671026, 0.9999999403953552, -0.0010027274256572127],
                 [0.0, 0.0, 0.0, 1.0]]))
        self.assertIsNone(
            np.testing.assert_array_equal(
                sensor.get_frame_T_rig_world(6, FrameTimepoint.END),
                [[1.0, 6.46427579340525e-05, -4.565540803014301e-05, -0.000817910477053374],
                 [-6.462900637416169e-05, 0.9999999403953552, 0.00030105686164461076, 0.00011379003990441561],
                 [4.5674863940803334e-05, -0.0003010538930539042, 0.9999999403953552, -0.0010945569956675172],
                 [0.0, 0.0, 0.0, 1.0]]))
