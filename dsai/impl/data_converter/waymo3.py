...
from dsai.impl.data.types import Poses, PinholeCameraModelParameters, ShutterType, TrackLabel, FrameLabel3, BBox3, LabelSource, DynamicFlagState
from dsai.impl.common.common import PoseInterpolator
from dsai.impl.common.transformations import transform_point_cloud, se3_inverse, transform_bbox
from dsai.impl.data_converter.data_converter import DataConverter
from dsai.impl.data_converter.waymo_utils import parse_range_image_and_segmentations, convert_range_image_to_point_cloud, extrapolate_pose_based_on_velocity
...
class WaymoConverter(DataConverter):
    ...
    def decode_cameras(self, frames):
        ...
        for camera_id, camera_name in self.CAMERA_MAP.items():
            ...
            # to
            # - DSAI camera: principal axis along the +z axis, the x-axis points to the right, and the y-axis points down
