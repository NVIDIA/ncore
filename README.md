...
```
cd existing_repo
git remote add origin https://gitlab-master.nvidia.com/zgojcic/drivesim-ai.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab-master.nvidia.com/zgojcic/drivesim-ai/-/settings/integrations)
