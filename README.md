...
The correct `bazel` version can be invoked most easily using the official `bazelisk` wrapper (see installation instructions at [bazelisk](https://github.com/bazelbuild/bazelisk#installation)).
